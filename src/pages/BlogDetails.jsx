            ...
            <div className="col-lg-8 col-md-12">
              <article className="blog-details">
                <div className="post-media">
                  ...
                  <div className="meta">
                    ...
                    <div className="item comments">Comments (5)</div>
                  </div>
                </div>
                ...
                <blockquote className="block-quote">
                  <h4>
                    ...
                    Character Sets The Ultim An Overview UX Design Deliverables
                  </h4>
              ...
              <div className="post-details">
                <div className="details-left">
                  <div className="wg-title style-2">Popular Tags</div>
                ...
                <div className="details-right">
                  <div className="wg-title style-2">Share Post</div>
              ...
              <div className="post-author style-2">
                ...
                <div className="content">
                  <h4>
                    <Link to="#">Herbert N. Johnson</Link>
                  </h4>
              ...
              <div className="widget item widget-post style-2">
                <div className="wg-title style-2">Related News</div>
              ...
              <div className="widget item wg-comments">
                <div className="wg-title">People Comments</div>
                <ul>
            ...
            <div className="col-lg-4 col-md-12">
              <aside className="side-bar">
                ...
                <div className="widget item wg-category">
                  <div className="wg-title">Category</div>
                  <ul>
                ...
                <div className="widget item widget-post style-3">
                  <div className="wg-title">Recent News</div>
                  <ul className="post-new">
                ...
                <div className="widget item wg-tags">
                  <div className="wg-title">Popular Tags</div>
                  <ul>
